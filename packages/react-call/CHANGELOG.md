...
- a087619: Fix: an end-all `end()` (called without a target promise) no longer drops calls made later in the same synchronous tick ([ADR-0020](docs/adr/0020-end-all-deferred-removal-scoped-to-resolved-calls.md)).
